...
<html>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav">
                                    <li class=""><a href="http://github.com/craftpip"><i class="fa fa-github fa-fw"></i> GITHUB HOME</a></li>
                                    <li class=""><a href="http://github.com/craftpip/jquery-confirm">PROJECT PAGE</a></li>
                                    <li class=""><a href="http://craftpip.com/#/contact">CONTACT</a></li>
                                </ul>
                            </div>
                        </div>
                    </nav>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    <div class="row">
                        <div class="col-md-3 col-sm-4" style="position:fixed">
                ...
                <div class="col-md-9 col-sm-8">
                    ...
                    <section id="introduction">
                        <header>
                            ...
                            <a href="https://github.com/craftpip/jquery-confirm/issues" target="empty" class="btn btn-success"><i class="fa fa-bug fa-fw"></i> Issues/Features here.</a>
                        </header>
                    </section>
                    <hr>
                        ...
                        <script type="text/javascript">
                            ...
                            $('.example-p-7').on('click', function () {
                                $.confirm({
                                    ...
                                    content: 'Press ENTER to confirm, ESC to cancel.<br> Use <kbd>keyboardEnabled:true</kbd> to turn it on.',
                                    confirm: function () {
    ...
    confirm: function(){
        alert('Confirmed!');
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="space10"></div>
                                <pre class="prettyprint linenums"><code class="js">$.confrim({
    title: 'Confirm!',
    content: 'Simple confirm!',
    confirm: function(){
        alert('Confirmed!');
    ...
    cancelButtonClass: 'btn-danger'
                    ...
                    <div class="section">
                        <p>The <u>light</u> &amp; <u>dark</u> themes that suit any website design, <br>
                        <u>HoloLight</u> and <u>HoloDark</u> themes for android web apps.
                        </p>
...
$.confirm({
    theme: 'holodark'
                    ...
                    <div class="section">
                        ...
                        <p class="text-info"><i class="fa fa-star fa-fw"></i> You can also load HTML contents to the modal with ease.</p>
...
$.confirm({
    ...
    keyboardEnabled: true
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Open &amp; Close animation for the dialog.<br>
                                        possible options are 'scale', 'top', 'bottom', 'left', 'right', 'zoom', 'opacity', 'none', 'rotate', 'rotatex', 'rotatey', 'scalex', 'scaley'.
                                        <br><span class="text-info">The 'blur' animation was removed at v1.1.2</span>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <h3 id="methods">RETURNED OBJECT</h3>
                    <p>
...
// Yeah, this is awesome
                    ...
                    <h3 id="methods">INSIDE CALLBACKS</h3>
                    <div class="section">
                        <h4>Getting the reference object inside callback functions</h4>
                        <p>You may need the retured reference obj inside the callback function, <code>this</code> is what you need.</p>
                        <pre class="prettyprint lineums"><code>var obj = $.confirm({
    title: 'awesome',
    content: 'Get me yeah.',
    confirm: function(){
