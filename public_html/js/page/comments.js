        ...
        confirm: function() {
            ...
            $.ajax({
               ...
               //console.log(convertedReturn);
                ...
                //     document.getElementById("companyListNames6").src = "https://'+ip+'/jezzy-mobile/public_html/img/icons/0.png"
    ...
    $.ajax({
        ...
        if(result!="") {
            ...
            for (var i = 0; i < convertedReturn.length; i++) {
                ...
                var name = Retorno.User.name.split(' ')[0];
                var dia = Retorno.OffersComment.date_register.split('-');
                ...
                if(Retorno.User.name != $.cookieStorage.get('User').name) {
                    HTML = "<div class='row col-xs-12 bottomLine' style='margin: 0%;padding: 0%;'><div class='col-xs-2' style='margin: 0%;padding: 0%;'><img style='width: 100%;border-radius: 100%;height:15vw; padding-left: 5%; padding-right: 5%;  ' src='" + Retorno.User.photo + "' id = 'photoUser" + Retorno.OffersComment.id + "'></div><div class='col-xs-10' style='margin: 0%;padding: 0%;'><div class='col-xs-12' style='margin: 0%;padding: 0%;'><div class='col-xs-7' style='margin: 0%;padding: 0%;'><span class='fontSizeClass tituloa' id='name_user'>" + name + "</span></div><div class='col-xs-5' style='margin: 0%;padding: 0%;'><div class='newAddressInfo marginTop10' style='margin: 0%;padding: 0%;' id='commentstars2'><img style='margin: 0%;padding: 0%;float: right; margin-right:5%;' src='"+notas+"' class='numberOfStars2' id='commentstars'/></div></div></div><div class='col-xs-12' style='margin: 0%;padding: 0%;'><div id='commentdescriptiontitle' class='commentdescriptiontitle'>"+Retorno.OffersComment.title + "</div></div><div class='col-xs-12' style='margin: 0%;padding: 0%;'><div id='commentdescription' class='commentdescription'>"+Retorno.OffersComment.description + "</div></div><div class='col-xs-12' style='margin: 0%;padding: 0%;'><div id='date' class='date'>"+ dia + " </div></div></div></div>";
                }else if(Retorno.User.name == $.cookieStorage.get('User').name){
                   //HTML = "<div class='row'><div class='col-xs-12'><div class='col-xs-3'><img src='" + Retorno.User.photo + "' id = 'photoUser" + Retorno.OffersComment.id + "' class='photoUser'></div><div class='col-xs-5'><span class='fontSizeClass tituloa name_user' id='name_user'>" + Retorno.User.name + "</span></div><div class='col-xs-4'><div class='col-xs-12 newAddressInfo marginTop10' id='commentstars2'><img src='"+notas+"' class='numberOfStars2' id='commentstars'/></div></div></div></div>";
                   HTML = "<div class='row col-xs-12 bottomLine'  onclick='deleteComment("+Retorno.OffersComment.id+");' style='margin: 0%;padding: 0%;'><div class='col-xs-2' style='margin: 0%;padding: 0%;'><img style='width: 100%;border-radius: 100%;height:15vw; padding-left: 5%; padding-right: 5%;    margin-left: 8%;' src='" + Retorno.User.photo + "' id = 'photoUser" + Retorno.OffersComment.id + "'></div><div class='col-xs-10' style='margin: 0%;padding: 0%;'><div class='col-xs-12' style='margin: 0%;padding: 0%;'><div class='col-xs-7' style='margin: 0%;padding: 0%;'><span class='fontSizeClass tituloa' id='name_user'>" + name + "</span></div><div class='col-xs-5' style='margin: 0%;padding: 0%;'><div class='newAddressInfo marginTop10' style='margin: 0%;padding: 0%;' id='commentstars2'><img style='margin: 0%;padding: 0%;float: right; margin-right:5%;' src='"+notas+"' class='numberOfStars2' id='commentstars'/></div></div></div><div class='col-xs-12' style='margin: 0%;padding: 0%;'><div id='commentdescriptiontitle' class='commentdescriptiontitle'>"+Retorno.OffersComment.title + "</div></div><div class='col-xs-12' style='margin: 0%;padding: 0%;'><div id='commentdescription' class='commentdescription'>"+Retorno.OffersComment.description + "</div></div><div class='col-xs-12' style='margin: 0%;padding: 0%;'><div id='date' class='date'>"+ dia + " </div></div></div></div>";
                   // HTML = "<div><img src='" + Retorno.User.photo + "' id = 'photoUser" + Retorno.OffersComment.id + "' class='photoUser'></div><span class='fontSizeClass tituloa name_user' id='name_user'>" + Retorno.User.name + "</span><div class='row numberOfStarsLine' onclick='deleteComment("+Retorno.OffersComment.id+");' id='commentstars3'><div class='col-xs-12 newAddressInfo marginTop10' id='commentstars2'><img src='"+notas+"' class='numberOfStars2' id='commentstars'/></div><div id='commentdescriptiontitle' class='commentdescriptiontitle'>"+Retorno.OffersComment.title + "</div><div id='commentdescription' class='commentdescription'>'"+Retorno.OffersComment.description + "'</div><div id='date' class='date'>"+Retorno.OffersComment.date_register + "</div><div class='bottomLine'></div></div>";
                }
            ...
            var Aviso = "<div class='commentdescriptiontitles' style='text-align:center;width:100%!important;margin-left:0%!important;'>Não há comentarios para esse produto!</div>";
