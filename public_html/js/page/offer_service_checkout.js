    ...
    $("#BtnPagamentoAviso").click(function () {
        if (document.getElementById("BtnPagamentoAviso").innerText == "REALIZAR PAGAMENTO") {
            if(JSON.parse(localStorage.getItem('FavCompany'))!= null && JSON.parse(localStorage.getItem('FavCompany'))!= undefined) {
                ...
                $("#BtnPagamentoAviso").html('<i class="fa fa-spinner fa-pulse fa-2x fa-fw" aria-hidden="true"></i>');
                    localStorage.setItem("ComissionedSecondaryUser", 0);
        ...
        $.ajax({
            ...
            $.ajax({
                ...
                if((convertedReturn.Offer.amount_allowed/1) == 0){
                    ...
                    $("#BtnPagamentoAviso").html("AVISE-ME QUANDO DISPONÍVEL");
