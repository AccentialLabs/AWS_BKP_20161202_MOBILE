                                    ...
                                    $.ajax({
                                        ...
                                        if (result == '') {											
                                            ...
                                            for (var b = 0; b < cont; b++) {
                                                ...
                                                var query = 'INSERT INTO offers_users (offer_id, user_id, date_register, target) VALUES (' + offer.offers.id + ", " + $.cookieStorage.get('User').id + ", '" + date + "', '');";
                    ...
                    if (result == "") {
                        ...
                        $.ajax({
                            ...
                            if (result != 'ImE6MDp7fSI=') {
                                ...
                                for (var b = 0; b < cont; b++) {
                                    var offer = convertedReturnD[b];
                                    var query = 'DELETE FROM offers_users WHERE offers_users.offer_id = ' + offer.offers.id + " and offers_users.user_id = " + $.cookieStorage.get('User').id + ";";
                                    ...
                                    $.ajax({
										...
										localStorage.setItem('unfollow', 1);
                                    }).error(function (XMLHttpRequest, textStatus, errorThrown) {
                                       // alert(errorThrown);
                                    });
                                }
...
function SendRequest() {
    ...
    */
    ...
    var conditions = {
        'User': {
            'query': "SELECT * FROM companies Company WHERE Company.status = 'ACTIVE' ORDER BY Company.fancy_name ASC"
        }
    };
