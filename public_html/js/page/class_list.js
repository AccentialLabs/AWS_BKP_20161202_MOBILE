...
function sendRequest(){
    ...
    $.ajax({
        ...
        if(result == "ImE6MDp7fSI="){
            generateModalAlert("Não há serviços cadastrados para este salão, ligue para<br><span itemprop='telephone'><a target='_blank' href='tel://0"+$.cookieStorage.get('Company').phone.trim().replace(" ", "")+"'>"+$.cookieStorage.get('Company').phone+"</a></span><br>e efetue o agendamento.");
			$("#messageModelGoesHere").css('font-size', '3.9vh');
            $('#mymodal').modal('show');
