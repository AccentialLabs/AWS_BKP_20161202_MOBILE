...
function preencher(){
    if(document.referrer == "https://"+ip+"/jezzy-mobile/public_html/my_profile.html") {
       ...
       //console.log(conditionsSave);
        ...
        $.ajax({
            ...
            var g = convertedReturn[(convertedReturn.length/1)-1];
            $("#label1").attr('value', g.AditionalAddressesUser.label);
            $("#address").attr('value', g.AditionalAddressesUser.address);
            $("#bairro").attr('value', g.AditionalAddressesUser.district);
            $("#cep").attr('value', g.AditionalAddressesUser.zip_code);
            $("#complement").attr('value', g.AditionalAddressesUser.complement);
            $("#number").attr('value', g.AditionalAddressesUser.number);
            $("#city").attr('value', g.AditionalAddressesUser.city);
            $("#state").attr('value', g.AditionalAddressesUser.state);
            $('#state option[value="'+g.AditionalAddressesUser.state+'"]').attr("selected", "selected");
               ...
               var g = convertedReturn[(convertedReturn.length/1)-1];
                ...
                var conditionsSave = {
                    'User': {
                        ...
                        'id_address': g.AditionalAddressesUser.id
                    }
                };
               //console.log(conditionsSave);
                var postDataSave = JSON.stringify(conditionsSave);
