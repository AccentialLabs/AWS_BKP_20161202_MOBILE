...
$(document).ready(function () {
    $("#acc1").click(function () {
        if ($("#acc1").hasClass("active")) {
			...
			$("#acc1img").attr('src', 'img/icons/mais.png');
            return false;
        } else {
			...
			$("#acc1img").attr('src', 'img/icons/menos.png');
    ...
    $("#acc0").click(function () {
        if ($("#acc0").hasClass("active")) {
            $("#acc0").removeClass("active");
            $("#panel0").addClass("hide");
			$("#acc0img").attr('src', 'img/icons/mais.png');
            return false;
        } else {
			$("#acc0").addClass("active");		
				$(".esconder").addClass("hide");
				$(".buttonplus").attr('src', 'img/icons/mais.png');
            $("#panel0").removeClass("hide");
			$("#acc0img").attr('src', 'img/icons/menos.png');
    ...
    $("#acc2").click(function () {
        if ($("#acc2").hasClass("active")) {
			...
			$("#acc2img").attr('src', 'img/icons/mais.png');
            return false;
        } else {
			...
			$("#acc2img").attr('src', 'img/icons/menos.png');			
            return false;
        }
    ...
    $("#acc3").click(function () {
        if ($("#acc3").hasClass("active")) {
			...
			$("#acc3img").attr('src', 'img/icons/mais.png');
            return false;
        } else {
			...
			$("#acc3img").attr('src', 'img/icons/menos.png');
    ...
    $("#acc4").click(function () {
        if ($("#acc4").hasClass("active")) {
			...
			$("#acc4img").attr('src', 'img/icons/mais.png');
            return false;
        } else {
			...
			$("#acc4img").attr('src', 'img/icons/menos.png');
            return false;
        }
...
function sendRequest() {
    ...
    $.ajax({
        ...
        $("#company_name").html(convertedReturn.Company.fancy_name.toUpperCase());
        $("#corporateaddress").append(convertedReturn.Company.address + ', ' + convertedReturn.Company.number + ' - ' + convertedReturn.Company.district + ', ' + convertedReturn.Company.city + ' - ' + convertedReturn.Company.state + " " + convertedReturn.Company.zip_code);
        ...
        var query = 'SELECT * FROM companies_photos WHERE companie_id =' + idcompany + ";";
        ...
        $.ajax({
            ...
            if (result != "") {
                ...
                for (var i = 0; i < convertedReturn.length; i++) {
                    if (i == 0) {
                        $("#preenchercarrossel").append('<div class="item active"><img src="' + convertedReturn[i].companies_photos.photo + '" style="object-fit: cover;width: 100%;height: 16em;" alt="Chania"></div>');
                        $("#preencher-indicators").append('<li data-target="#myCarousel" data-slide-to="' + i + '" class="active"></li>');
                    } else {
                        $("#preenchercarrossel").append('<div class="item"><img src="' + convertedReturn[i].companies_photos.photo + '" style="object-fit: cover;width: 100%;height: 16em;" alt="Chania"></div>');
                        $("#preencher-indicators").append('<li data-target="#myCarousel" data-slide-to="' + i + '"></li>');
                    }

                }

            } else {
                $("#acc0row").addClass("hide");
            }
